    ...
    <div className="drawer-overlay" onClick={onClose}>
      <div className="drawer-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="drawer-body">
          ...
          {/* Cloud Backup & Multi-Device Sync Section */}
          <div>
            <div className="settings-section-title">
            ...
            >
              ...
              >
                <div>
                  <div style={{ fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-main)' }}>
                    ...
                    {syncStatus === 'error' && '🔴 Sync Issue Detected'}
              ...
              <p style={{ fontSize: '0.8125rem', color: 'var(--text-muted)', lineHeight: 1.4 }}>
                Synchronises your shifts and settings seamlessly to a private GitHub Gist so you
          ...
          {onLogout && (
            <div>
              ...
              >
                <p style={{ fontSize: '0.8125rem', color: 'var(--text-muted)' }}>
                  Lock this session and return to the authorisation screen. This will clear the
                  cached passphrase from this device.
                </p>
